package com.example.lhtjwtlogin.controller;

import com.example.lhtjwtlogin.dto.request.SignInForm;
import com.example.lhtjwtlogin.dto.request.SignUpForm;
import com.example.lhtjwtlogin.dto.response.JwtResponse;
import com.example.lhtjwtlogin.dto.response.ResponseMessage;
...
import com.example.lhtjwtlogin.security.jwt.JwtProvider;
import com.example.lhtjwtlogin.service.impl.RoleServiceImpl;
import com.example.lhtjwtlogin.service.impl.UserServiceImpl;
    ...
    public ResponseEntity<?> register(@Valid @RequestBody SignUpForm signUpForm){
        ...
        strRoles.forEach(role->{
            switch (role){
                ...
                case "pm":
                    Role pmRole =
                            roleService.findByName(RoleName.PM)
                                    .orElseThrow(()-> new RuntimeException("Role not found"));
                    roles.add(pmRole);
                    break;
                default:
